...
public class ProjectCodeGenerator {
  ...
  void generateClassHeader(StringBuilder objectsSb) {
    ...
    objectsSb.append("import java.util.concurrent.locks.ReentrantLock;\n\n");
    ...
    objectsSb.append("  public static final ReentrantLock globalLock = new ReentrantLock(true);\n\n");
  }
  ...
  void generateClassFooter(StringBuilder objectsSb) {
    ...
    objectsSb.append("    stage.registerScripts();\n");
